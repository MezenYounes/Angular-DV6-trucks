...
export class CamionService {
  ...
  constructor() {
    ...
    {idmar : 4, nommar : "FORD"}];
    this.camions = [
    {idcamion : 1, nomcamion : "Ford F-150", prixcamion: 35000 , description : "Le Ford F-150 est un camion pick-up populaire et polyvalent", marque : {idmar : 4, nommar : "FORD"}},
    {idcamion : 2, nomcamion : "Toyota Tacoma", prixcamion :  45000, description : "Le Toyota Tacoma est un camion compact durable et fiable", marque : {idmar : 1, nommar : "TOYOTA"}},
    {idcamion : 3, nomcamion :"Chevrolet Silverado", prixcamion : 55000, description : "Le Chevrolet Silverado 2500HD est un camion lourd conçu pour les tâches les plus exigeantes", marque : {idmar : 3, nommar : "chevrolet"}}
     ];
    }
    listecamion():camion[] {
